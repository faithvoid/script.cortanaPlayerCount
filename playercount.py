...
def main():
    ...
    xbmc.executebuiltin('Skin.SetString(totalOnline, "{}")'.format(combined_string))
    xbmc.executebuiltin('Skin.SetString(insigniaOnline, "{}")'.format(insignia_string))
    xbmc.executebuiltin('Skin.SetString(xlinkOnline, "{}")'.format(xlink_string))
    xbmc.executebuiltin('Skin.SetString(xlinkSessions, "{}")'.format(xlinksession_string))
    xbmc.executebuiltin('Skin.SetString(insigniaSessions, "{}")'.format(insigniasession_string))
